...
def get_parsed_commandline_options():
    ...
    parser.add_option("-e", "--evaluation-metric-mode",
                      ...
                      help="Specify the evaluation metric mode." + \
                           ...
                           "'-e4' =Use Illuminance Measure (Lambertian only) to evaluate 'Single Edge(10:3926)' loaded file; depends on properties file values: see '[EvaluateEdgeMapSingleResultsFile]'" + \
