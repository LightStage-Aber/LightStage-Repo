...
class MeasureReflectanceIntoCameras( Evaluator ):
    ...
    This method uses two metrics:
        ...
        - illuminance score, accumulate the amount of diffuse/specular light reflected into the cameras.
    
    """
    def __init__(self):
        self.illumination_coverage_datastructure = accumulated_coverage_datastructure()
                            ...
                            for cam_num in range(len(camerasVertices)):
                                ...
                                if is_front_facing_reflection_to_camera(tri, cam):
                                    ...
                                    if kwords['DO_EVALUATIONS']:
                                        ...
                                        self.illumination_coverage_datastructure.add( coverage_score, led_num, tri_num)
                                    else:
    ...
    #        print("Coverage Score",best_score, best_leds)
            if kwords['DO_EVALUATIONS']:
                led_to_tri_reflection_map           = self.illumination_coverage_datastructure.get()
